...
OUTPUT_ROOT=${OUTPUT_ROOT:-/mnt/afs_1/charles/codes/LIBERO-plus/eval_results/fastwam_20step_1trial_official}
PROTOCOL_DIRECTORY=${FASTWAM_20STEP_1TRIAL_PROTOCOL_DIRECTORY:-official_protocol_shared_policy_20step_1trial_fcf10f6a}
...
"$PYTHON" "$EVALUATOR" \
    ...
    --model-path /mnt/afs_1/charles/models/Wan2.2-TI2V-5B \
    --policy-config "$POLICY_CONFIG" \
    --dataset-stats /mnt/afs_1/charles/models/fastwam/libero_uncond_2cam224_dataset_stats.json \
    --libero-root /mnt/afs_1/charles/codes/LIBERO-plus \
