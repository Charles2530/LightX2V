...
@pytest.mark.parametrize("method,weights,expected", [
    ("fasterwam_action_consistency", "auto", "ema"),
    ("fasterwam_action_consistency", "ema", "ema"),
    ("fasterwam_action_consistency", "student", "student"),
])
def test_export_selects_weights_and_merges_lora(exporter, tmp_path, monkeypatch, method, weights, expected):
    ...
    wrapped = exporter.configure_fasterwam_action_role(expert(), parsed.student)
